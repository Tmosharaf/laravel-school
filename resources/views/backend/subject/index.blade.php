                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <p class="font-medium">{{ $subject->subject_code }}</p>
                                    </div>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <p class="font-medium">{{ $subject->subject_name }}</p>
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-sm">

                                    <a href=""
                                        class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">{{ $subject->classes->name }}</a>
                                </td>
                                <td class="px-4 py-3">
        ...
        <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
            <form action="{{ route('subject.index') }}" method="get">
                ...
                <input
                    ...
                    type="text" placeholder="Search for projects" name="search" aria-label="Search" />
            </form>
        </div>
    @endsection
</x-app-layout>

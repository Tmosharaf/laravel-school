            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                @foreach ($classes as $class)
                    ...
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                        ...
                        <div>
                            <a href="{{ route('classes.show', $class->name) }}" class="mb-2 text-md font-sm bg-purple-600 hover:bg-purple-700  dark:text-gray-400 rounded-lg text-white inline-block px-3 py-1">
                                {{ $class->name }}
                            </a>

            ...
            <form action="{{ route('student.update', $student) }}" method="post"
                ...
                <label class="block text-sm ">
                    ...
                    <input type="text"
                        ...
                        value="{{ $student->name }}" name="name" placeholder="Name">
                    {{-- Errors --}}
                    @error('name')
                ...
                <label class="block text-sm ">
                    ...
                    <input type="number"
                        ...
                        value="{{ $student->roll }}" name="roll" placeholder="roll">
                        {{-- Errors --}}
                        @error('roll')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                    ...
                    <label class="block text-sm mb-4">
                        ...
                        <select class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            ...
                            @foreach (\App\Models\Classes::select('id', 'name')->get() as $class)
                                <option value="{{ $class->id }}"
                                    {{ ($student->classes_id == $class->id) ? 'selected' : ''}}
                                >{{ $class->name }}</option>
                            @endforeach
                        </select>
                ...
                {{-- <label class="block text-sm ">
                    ...
                    <input type="email"
                        ...
                        value="{{ $student->email }}" name="email" placeholder="Email">
                    {{-- Errors --}}
                    {{-- @error('email')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                ...
                <label class="block text-sm ">
                    ...
                    <input type="tel"
                        ...
                        value="{{ $student->phone }}" name="phone" placeholder="Phone">
                    {{-- Errors --}}
                    @error('phone')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                ...
                <label class="block text-sm ">
                    ...
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input
                        ...
                        value="{{ $student->fathers_name }}" name="fathers_name" placeholder="Mr. Rahman">
                        {{-- Errors --}}
                    @error('fathers_name')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                ...
                <label class="block text-sm ">
                    ...
                    <input type="text"
                        ...
                        value="{{ $student->mothers_name }}" name="mothers_name" placeholder="Mrs. Mahmuda">
                    {{-- Errors --}}
                    @error('mothers_name')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                ...
                <label class="block text-sm mb-4">
                    ...
                    name="address" placeholder="Address">{{ $student->address }}</textarea>
                    {{-- Errors --}}
                    @error('address')
                    <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                    ...
                    <label class="block text-sm ">
                        ...
                        <div class="flex ">
                            <div class="flex items-center mr-4">
                                <input   {{ ($student->gender == 1  ? 'checked=""' : '') }}
                                    id="inline-radio" type="radio" value="1" name="gender"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="inline-radio"
                                    class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Male</label>
                            </div>
                            <div class="flex items-center mr-4">
                                <input   {{ ($student->gender == 2  ? 'checked=""' : '') }}
                                    id="inline-2-radio" type="radio" value="2" name="gender"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="inline-2-radio"
                                    class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Female</label>
                            </div>
                            <div class="flex items-center mr-4">
                                <input  {{ ($student->gender == 3  ? 'checked=""' : '') }}
                                    id="inline-checked-radio" type="radio" value="3"
                                    name="gender"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <label class="block text-sm mb-4">
                    ...
                    <select class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        name="group" id="group">
                        <option {{ ($student->group == 1) ? 'selected' : '' }} value="1">Science</option>
                        <option {{ ($student->group == 2) ? 'selected' : '' }}value="2">Commerce</option>
                        <option {{ ($student->group == 3) ? 'selected' : '' }} value="3">Arts</option>
                    </select>
                    {{-- Errors --}}
                    @error('group')
                        <span class="text-xs text-red-600 dark:text-red-400">
                ...
                <label class="block text-sm mb-4">
                    ...
                    <input type="number"
                        ...
                        value="{{ $student->session }}" name="session" placeholder="2018">
                    {{-- Errors --}}
                    @error('session')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}

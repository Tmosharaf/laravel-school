        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="grid gap-6 mb-8 md:grid-cols-3">
                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <h6 class="text-gray-600 dark:text-gray-300">{{ $class->teacher->name ?? ''}}</h6>
                    <span class="text-xs text-gray-600 dark:text-gray-300">{{ $class->teacher->education ?? '' }}</span>
                    <p class="text-gray-600 text-sm">{{ $class->teacher->description ?? ''}}</p>
                </div>
